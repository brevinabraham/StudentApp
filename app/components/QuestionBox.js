...
export function QuestionBox ({ question, img, onClose, editQuestion, isOpen, setIsOpen, onConversationPress, expanded  }) {
        ...
        <View style={{ margin: 10, flex: 1 }}>
            <View>
                ...
                <Animated.View style={{
                    position:'absolute',
                    zIndex:-1,
                    transform: [{ translateX: translate_U, opacity: translate_U_opacity }],
            ...
            <AnswersSection onPress={onConversationPress} />
        </View>
    );
}
